...
def create_llm_cache_callbacks(
  ...
  async def before_model_callback(
    ...
    return await cache.before_model_callback(callback_context, llm_request)

  async def after_model_callback(
      callback_context: CallbackContext,
      llm_response: LlmResponse,
  ) -> Optional[LlmResponse]:
    return await cache.after_model_callback(callback_context, llm_response)
...
def create_tool_cache_callbacks(
  ...
  async def before_tool_callback(
    ...
    return await cache.before_tool_callback(tool, args, tool_context)
  ...
  async def after_tool_callback(
    ...
    return await cache.after_tool_callback(
